...
public class peliculaDao extends baseDao{
    ...
    public ArrayList<pelicula> listarPeliculas() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String streamin = rs.getString("nombreServicio");

                Boolean premioscar = rs.getBoolean ("premioOscar");
                movie.setGenero(nombregenero);
                movie.setStreaming(streamin);
                movie.setPremioOscar(premioscar);
    ...
    public void borrarPelicula(int idPelicula) {
        ...
        String sql = "delete from pelicula where job_id = ?";
